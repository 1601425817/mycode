         ...
         <form id="expand" action="/FinacialSys/editExpand/${current}/${id}" method="post">
	        <div class="cont_form_sign_up"> <a href="#" onClick="ocultar_login_sign_up()"><i class="fa fa-arrow-left"></i></a>
	          <h2>基本信息</h2> 
	       		  ...
	       		  <input type="text" value="${ expand.outMoney}" name="outMoney" required='required'/>
		          <input type="text" value="${ expand.outPlace }" name="outPlace" required='required'/>
		          <input type="text" value="${ expand.outMessage }" name="outMessage" required='required'/>
		          <input type="text" value="${ expand.outTime }" name="outTime" id="expandDate" required='required'/>
