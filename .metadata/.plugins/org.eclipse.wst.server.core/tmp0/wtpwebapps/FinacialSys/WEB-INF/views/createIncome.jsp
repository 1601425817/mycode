        ...
        <div class="cont_form_login"> <a href="#" onClick="ocultar_login_sign_up()" ><i class="fa fa-arrow-right"></i></a>
         ...
         <form id="income" action="createIncome" method="post">
	        <div class="cont_form_sign_up"> <a href="#" onClick="ocultar_login_sign_up()"><i class="fa fa-arrow-left"></i></a>
	          <h2>基本信息</h2> 
		          <input type="text" placeholder="收入金额" name="inMoney" required='required'/>
		          <input type="text" placeholder="收入地点" name="inPlace" required='required'/>
		          <input type="text" placeholder="收入详细信息" name="inMessage" required='required'/>
		          <input type="text" placeholder="收入日期" name="inTime" class="laydate-icon" id="incomeDate" required='required'/>
