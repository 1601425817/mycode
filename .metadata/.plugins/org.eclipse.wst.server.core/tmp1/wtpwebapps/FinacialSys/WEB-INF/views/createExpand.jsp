        ...
        <div class="cont_form_login"> <a href="#" onClick="ocultar_login_sign_up()" ><i class="fa fa-arrow-right"></i></a>
         ...
         <form id="expand" action="createExpand" method="post">
	        <div class="cont_form_sign_up"> <a href="#" onClick="ocultar_login_sign_up()"><i class="fa fa-arrow-left"></i></a>
	          <h2>基本信息</h2> 
		          <input type="text" placeholder="支出金额" name="outMoney" required='required'/>
		          <input type="text" placeholder="支出地点" name="outPlace" required='required'/>
		          <input type="text" placeholder="支出详细信息" name="outMessage" required='required'/>
		          <input type="text" placeholder="支出日期" name="outTime" class="laydate-icon" id="expandDate" required='required'/>
